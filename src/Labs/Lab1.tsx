export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-forms">
        <h4>Form Elements</h4>
        {/* <form id="wd-text-fields" action="myserver.com"> */}
        <h5>Text Fields</h5>
      ...
      <label>Favorite movie genre (select one):</label>
      <br />
      ...
      <h5>Favorie Colors</h5>
      <label>Choose one:</label>
      <br />
      <input type="radio" name="wd-color" id="wd-color-red" />
      <label htmlFor="wd-color-red">Red</label>
      <br />
      <input type="radio" name="wd-color" id="wd-color-green" />
      <label htmlFor="wd-color-green">Green</label>
      <br />
      <input type="radio" name="wd-color" id="wd-color-blue" />
      <label htmlFor="wd-color-blue">Blue</label>
      <br />
      <input type="radio" name="wd-color" id="wd-color-yellow" />
      <label htmlFor="wd-color-yellow">Yellow</label>
      <br />
